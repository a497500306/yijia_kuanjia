...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "EaseMobDIYUI/EaseMobUI/Resource/EM_Resource.bundle"
  install_resource "EaseMobDIYUI/EaseMobUI/Resource/EM_ChatStrings.strings"
  install_resource "EaseMobDIYUI/EaseMobUI/Resource/EM_Web.bundle"
  install_resource "EaseMobDIYUI/EaseMobUI/Resource/EM_ChatModel.xcdatamodeld"
  install_resource "EaseMobDIYUI/EaseMobUI/EaseMobUI/Common/Rdparty/GPUImage/framework/Resources/lookup.png"
  install_resource "EaseMobDIYUI/EaseMobUI/EaseMobUI/Common/Rdparty/GPUImage/framework/Resources/lookup_amatorka.png"
  install_resource "EaseMobDIYUI/EaseMobUI/EaseMobUI/Common/Rdparty/GPUImage/framework/Resources/lookup_miss_etikate.png"
  install_resource "EaseMobDIYUI/EaseMobUI/EaseMobUI/Common/Rdparty/GPUImage/framework/Resources/lookup_soft_elegance_1.png"
