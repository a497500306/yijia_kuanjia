...
-(void)setup
{
    if(!_dialogView)
    {
        ...
        _dialogView.backgroundColor = [UIColor yellowColor];
    ...
    inputView.layer.borderColor = [UIColor yellowColor].CGColor;
    ...
    _cancelBtn.layer.borderColor =[UIColor yellowColor].CGColor;
    ...
    [_okBtn setTitleColor:[UIColor yellowColor] forState:UIControlStateDisabled];
    [_okBtn setBackgroundImage:[UIImage imageWithColor:[UIColor yellowColor]] forState:UIControlStateNormal];
    [_okBtn setBackgroundImage:[UIImage imageWithColor:[UIColor yellowColor]] forState:UIControlStateDisabled];
